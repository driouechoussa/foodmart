...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('styles/vendor.css') }}">
  ...
  <body>
    ...
    <section class="py-3" style="background-image: url('{{ asset('images/patterns/background-pattern.jpg') }}');background-repeat: no-repeat;background-size: cover;">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="banner-blocks">
                  ...
                  <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        ...
                        <div class="img-wrapper col-md-5">
                          <img src="{{ asset('images/products/product-thumb-1.png') }}" class="img-fluid">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        ...
                        <div class="img-wrapper col-md-5">
                          <img src="{{ asset('images/products/product-thumb-2.png') }}" class="img-fluid">
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="banner-ad bg-success-subtle block-2" style="background:url('{{asset('images/ads/ad-image-1.png') }}') no-repeat;background-position: right bottom">
                <div class="row banner-content p-5">
                  <div class="content-wrapper col-md-7">
                    <div class="categories sale mb-3 pb-3">20% off</div>
                    <h3 class="banner-title">Fruits & Vegetables</h3>
                    <a href="#" class="d-flex align-items-center nav-link">Shop Collection</a>
                  </div>

                </div>
              </div>

              <div class="banner-ad bg-danger block-3" style="background:url('{{asset('images/ads/ad-image-2.png') }}') no-repeat;background-position: right bottom">
                <div class="row banner-content p-5">
            ...
            <div class="category-carousel swiper">
              <div class="swiper-wrapper">
                <a href="index.html" class="nav-link category-item swiper-slide">
                  <img src="{{ asset('images/icons/icon-vegetables-broccoli.png') }}" alt="Category Thumbnail">
                  <h3 class="category-title">Fruits & Veges</h3>
                </a>
                <a href="index.html" class="nav-link category-item swiper-slide">
                  <img src="{{ asset('images/icons/icon-bread-baguette.png') }}" alt="Category Thumbnail">
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="{{ asset('images/brands-items/product-thumb-11.jpg') }}" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="{{ asset('images/brands-items/product-thumb-12.jpg') }}" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body py-0">
                          <p class="text-muted mb-0">Amber Jar</p>
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="{{asset('images/brands-items/product-thumb-13.jpg')}}" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body py-0">
                          <p class="text-muted mb-0">Amber Jar</p>
    ...
    <section class="py-5">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="banner-ad bg-danger mb-3" style="background: url('images/ads/ad-image-3.png');background-repeat: no-repeat;background-position: right bottom;">
          ...
          <div class="col-md-6">
            <div class="banner-ad bg-info" style="background: url('images/ads/ad-image-4.png');background-repeat: no-repeat;background-position: right bottom;">
              <div class="banner-content p-5">
        ...
        <div class="row">
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="{{asset('images/posts/post-thumb-1.jpg')}}" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
          ...
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="{{asset('images/posts/post-thumb-2.jpg')}}" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
                <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
          ...
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="{{asset('images/posts/post-thumb-3.jpg')}}" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
                <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
      ...
      <div class="container-fluid">
        ...
        <div class="bg-warning py-5 rounded-5" style="background-image: url('images/bg-pattern-2.png') no-repeat;">
          <div class="container">
            <div class="row">
              <div class="col-md-4">
                <img src="{{asset('images/patterns/phone.png')}}" alt="phone" class="image-float img-fluid">
              </div>
              <div class="col-md-8">
        ...
        <div class="row row-cols-1 row-cols-sm-3 row-cols-lg-5">
            ...
            <div class="card mb-3 border-0">
              <div class="row">
                <div class="col-md-2 text-dark">
                  <img src="{{asset('images/icons/delevery.svg')}}" alt="delevery">
                </div>
                <div class="col-md-10">
          ...
          <div class="col">
            <div class="card mb-3 border-0">
              <div class="row">
                <div class="col-md-2 text-dark">
                    <img src="{{asset('images/icons/payment.svg')}}" alt="pyment">
                </div>
                <div class="col-md-10">
                  <div class="card-body p-0">
          ...
          <div class="col">
            <div class="card mb-3 border-0">
              <div class="row">
                <div class="col-md-2 text-dark">
                <img src="{{asset('images/icons/shop.svg')}}" alt="shop">
                </div>
                <div class="col-md-10">
                  <div class="card-body p-0">
          ...
          <div class="col">
            <div class="card mb-3 border-0">
              <div class="row">
                <div class="col-md-2 text-dark">
                  <img src="{{asset('images/icons/save.svg')}}" alt="save">
                </div>
                <div class="col-md-10">
                  <div class="card-body p-0">
          ...
          <div class="col">
            <div class="card mb-3 border-0">
              <div class="row">
                <div class="col-md-2 text-dark">
                  <img src="{{asset('images/icons/gifts.svg')}}" alt="gift">
                </div>
                <div class="col-md-10">
                  <div class="card-body p-0">
                    <h5>Daily offers</h5>
                ...
                <ul class="d-flex list-unstyled gap-2">
                  <li>
                    <a href="#" class="btn btn-outline-light">
                      <img class="footerSocialLinks" src="{{asset('images/icons/facebook.svg')}}" alt="facebook">
                    </a>
                  </li>
                  <li>
                    <a href="#" class="btn btn-outline-light">
                      <img class="footerSocialLinks" src="{{asset('images/icons/twitter.svg')}}" alt="twitter">
                    </a>
                  </li>
                  <li>
                    <a href="#" class="btn btn-outline-light">
                      <img src="{{asset('images/icons/youtube.svg')}}" alt="youtube" class="footerSocialLinks">
                    </a>
                  </li>
                  <li>
                    <a href="#" class="btn btn-outline-light">
                      <img src="{{asset('images/icons/instagram.svg')}}" alt="instagram" class="footerSocialLinks">
                    </a>
                  </li>
                  <li>
                    <a href="#" class="btn btn-outline-light">
                      <img src="{{asset('images/icons/amazon.svg')}}" alt="amazon" class="footerSocialLinks">
                    </a>
                  </li>
                </ul>
              </div>
